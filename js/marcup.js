(function($,window,document) {
	...
	/*
	function dohoudini(prestige) {
	  $("#intro h3").each(function () {
		$(this).before($('<a href="#" class=tellmemore>tell me more</a>').click(function (e) {
		  e.preventDefault();
		  $(this).nextUntil(".tellmemore").slideDown('fast').next(".tellmemore").show();
		  $(this).remove();
		}));
	  });
	  prestige($("#intro .tellmemore:first"));
	}
	*/
	...
	function loadSocials() {
		...
		getTopArtistsLastfm(2,"7day",function(artistname,artisturl,imgsrc,rank) { 
		...
		fetchLatestInstagram(2,function(imgsrc,link,caption,timestamp) {
		...
		fetchLatestFoursquare(2, function (venuename, venuelocation, link, imgsrc, timestamp) {
